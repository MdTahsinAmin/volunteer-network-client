    ...
    return (
      <div className="header">
          ...
          <nav className="navbar navbar-expand-lg navbar-light">
            ...
            {
                !props.navbar && <h5 className="volunteer-title">Volunteer register list</h5>
            }
              ...
              { (props.navbar && props.btnShow &&!volunteers.isLogin)&& <li className="nav-item">
                  <Link to='/login'><MyButton>Register</MyButton> </Link>
                </li>
              }
