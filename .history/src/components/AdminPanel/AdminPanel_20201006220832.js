    ...
    return (
        <div className="adminPanel-section">
            ...
            <div className='Volunteer-list'>
              ...
              {stateChange.addEvent &&<h5 className='swapTitle'>Add Event</h5>}
              {stateChange.groupList &&<h5 className='swapTitle'>Volunteer Register List</h5>}
              {stateChange.formal &&<h5 className='swapTitle'>Volunteer Register List</h5> }
